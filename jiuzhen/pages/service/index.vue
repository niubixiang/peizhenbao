			...
			<view class="pub-box-bd">
				<view class="weui-cell weui-cell_input">
					<view class="weui-cell__hd">
						<image class="serv-icon" :src="service.icon_image ? service.icon_image_url:'../../resource/images/avatar.jpg'"></image>
					</view>
				...
				<view class="pub-box-bd">
					<view class="weui-cell weui-cell_input">
						...
						<view class="weui-cell__ft weui-cell__ft_in-access">
							<view>
								<picker @change="onHospitalChange" :value="hospitals_index" :range="hospitals" range-key="name">
